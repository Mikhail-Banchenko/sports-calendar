                        ...
                        <div class="mb-4">
                            ...
                            <select id="_sport_id" name="_sport_id" 
                                ...
                                @foreach($sports as $sport)
                                    <option value="{{ $sport->id }}" {{ (string)$sport->id === old('_sport_id') ? 'selected' : '' }}>
                                        {{ $sport->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-4">
                            ...
                            <select id="_team_left_id" name="_team_left_id"
                                ...
                                @foreach($teams as $team)
                                    <option value="{{ $team->id }}" {{ (string)$team->id === old('_team_left_id') ? 'selected' : '' }}>
                                        {{ $team->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-4">
                            ...
                            <select id="_team_right_id" name="_team_right_id"
                                class="mt-1 block w-full bg-gray-100 dark:bg-gray-700 border-gray-300 dark:border-gray-700 rounded-md shadow-sm
                                    ...
                                    <option value="">{{ __('Select team') }}</option>
                                @foreach($teams as $team)
                                    <option value="{{ $team->id }}" {{ (string)$team->id === old('_team_right_id') ? 'selected' : '' }}>
                                        {{ $team->name }}
                                    </option>
                                @endforeach
                            </select>
